...
const Sponsors = () => {
  return (
    <div className="wrapper bg-blue pb-100 " style={{ backgroundImage: "linear-gradient(to top, rgba(96, 130, 182,0) 0%,rgba(96, 130, 182,0.1) 50%,rgba(96, 130, 182,0.2) 100%)" }}>
      <div className="container text-center mx-auto text-white font-bold">
      <div className="flex flex-col justify-center">
    {cat1.map((item, index) => (
      <div key={"spon" + index} className="flex flex-col justify-center col-12 mb-[16px]">
        <br />
        {/* <h1>{item["name"]}</h1> */}
        <SponsorText
				title={<>{item["name"]}</>}
